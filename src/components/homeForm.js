  ...
  marks :''
    ...
    return (
        ...
        <div  style={{minHeight:'50px', padding:'20px'}}> 
            <input className="resetButtonStyle"    type="submit" value="Reset" onClick={resetHandler} />           
            <input className="updateButtonStyle"  type="submit" value="Update" onClick={updateHandler} />
            <input className="submitButtonStyle" type="submit" value="Save"/>
        </div>
      </div>
    )
}
